//Approach 1: Simple traversal, use two for loops
//Time complexity: O(n^2)

//---------------------------------------------------------
//Approach 2: Maximizing the profit using extra variables
...
//--------------------------------------------------------------
//Appraoch 3: Using dynamic programming
//Time Complexity: O(n)
/*
...
After iteration i, the array profit[0..i] contains the maximum profit with 2 transactions, and profit[i+1..n-1] 
contains profit with two transactions.
*/
